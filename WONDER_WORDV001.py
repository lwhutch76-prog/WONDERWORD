    ...
    if not copied_successfully:
        try:
            with open(score_file_path, "w", encoding="utf-8") as f:
                ...
                f.write("299788,STEVE,1,0.1,07/28/26  03:21PM\n") 
                f.write("287632,HOLLY,3,0.8,07/16/26  09:17AM\n") 	
                f.write("271778,JAN,5,1.8,07/21/26  11:19AM\n") 
                f.write("260288,ELAINE,8,4.7,07/31/26  05:33PM\n") 
                f.write("259784,D TRUMP,3,0.1,07/19/26  04:07PM\n") 
                f.write("243512,CANDY,7,0.9,08/12/26  11:07PM\n")
                f.write("239352,BILLIE,7,0.9,08/12/26  1:07AM\n")
        except Exception:
            pass
...
pygame.display.set_caption("WONDER WORD Version 01........AUGUST 19, 2026")
...
def get_strategic_hints(word_bank, letters_not_in_word, letters_in_word, letters_might_be_in_word, hold_secret_word, top_n=2):
    ...
    # FIXED: Sort strictly by the score (index 1 of the tuple), not the alphabetical word!
...
def quit_game():
    ...
    rect_word = text_word.get_rect(center=(150, 20))
    rect_score = text_score.get_rect(center=(150, 60))
    rect_thanks = text_thanks.get_rect(center=(150, 100))
