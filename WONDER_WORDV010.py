    ...
    if not copied_successfully:
        try:
            with open(score_file_path, "w", encoding="utf-8") as f:
                f.write("100000,ALPHA,1,1.0,08/17/26  12:00PM\n")
                f.write("150000,BRAVO,2,1.5,08/17/26  12:01PM\n")
                f.write("100000,CHARLIE,3,2.0,08/17/26  12:02PM\n")
                f.write("150000,DELTA,4,2.5,08/17/26  12:03PM\n")
                f.write("100000,ECHO,5,3.0,08/17/26  12:04PM\n")
                f.write("150000,FOXTROT,6,3.5,08/17/26  12:05PM\n")
                f.write("100000,GOLF,7,4.0,08/17/26  12:06PM\n")
                f.write("150000,HOTEL,8,4.5,08/17/26  12:07PM\n")
                f.write("100000,INDIA,9,5.0,08/17/26  12:08PM\n")
        except Exception:
            pass
