...
#                f.write("383156,OGLE,7,1.9,07/04/26  01:27PM\n") 
    ...
    if not copied_successfully:
        try:
            with open(score_file_path, "w", encoding="utf-8") as f:
                ...
                f.write("143156,MYRA,7,1.9,07/04/26  01:27PM\n") 
                ...
                f.write("233512,MARIA,7,0.9,08/12/26  1:07AM\n")
...
pygame.display.set_caption("WONDER WORD Version 03........SEPTEMBER 30, 2026")
