...
try:
    ...
    sound_theme_music = pygame.mixer.Sound(sound_dir_path / "TheEnd.wav")  
    sound_theme_music.set_volume(0.0)
...
pygame.display.set_caption("WONDER WORD Version 9")
...
# STATE 5: ACTIVE GAME PLAY ENGINE (Standard Commands & Guesses) 
                ...
                # 5-Letter Word Entry Evaluations
                    ...
                    if processed_input == "ERROR":
                        ...
                        celebration_fireworks.launch(random.randint(50, 400), random.randint(100, 250))
                        celebration_fireworks.launch(random.randint(450, 650), random.randint(50, 200))
                        celebration_fireworks.launch(random.randint(700, 950), random.randint(120, 860))
...
# >>> INSERT THIS BRAND NEW BRANCH HERE <<<
    ...
    # Paint the safe, refactored wartime narrative window
        ...
        if firework_timer >= 45:  # Every 1.5 seconds...
            ...
            celebration_fireworks.launch(random.randint(100, 850), random.randint(100, 400))
